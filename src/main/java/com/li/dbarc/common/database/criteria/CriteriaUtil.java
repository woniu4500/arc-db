package com.li.dbarc.common.database.criteria;
...
import com.li.dbarc.common.database.Filter.Comparison;
import com.li.dbarc.common.database.Filter.Data;
import com.li.dbarc.common.web.util.DateUtil;
...
public final class CriteriaUtil {
	...
	public static Object convertonevalue(Object orgvalue, String type,
		...
		if (Filter.DATE.equalsIgnoreCase(type) && orgvalue instanceof String) {
			return DateUtil.parseDateFromVo2Db((String) orgvalue);
		}
		// condition time 14
		// ADDED FOR TIME
		if (Filter.TIME.equalsIgnoreCase(type) && orgvalue instanceof String ) {
			return DateUtil.parseDateFromVo2Db14((String) orgvalue);
		}
