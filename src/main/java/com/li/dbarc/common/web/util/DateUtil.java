...
public final class DateUtil {
	 ...
	 * @return the string
	 */
	public static String string2Time(String date) {
		if (date == null || date.length() != NUM_14){
			return null;
		}
		return date.substring(0, NUM_4) + "-" +  date.substring(NUM_4, NUM_6) + "-" + date.substring(NUM_6, NUM_8) +" "+date.substring(NUM_8, NUM_10)+":"+date.substring(NUM_10, NUM_12);
	}
